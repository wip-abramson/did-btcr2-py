...
from libbtcr2.did import encode_identifier, KEY, EXTERNAL, decode_identifier
    ...
    good_encode_decode_tests = [
            {
                ...
                "identifier_components": {
                    ...
                    "version": 1,
                    "network": "bitcoin",
                    "genesis_bytes": bytes.fromhex("02be8aa46e14038248c5cb6fd744a9f186de440344634b7bef02e830b0e2e90826")
                }
            },
            {
                ...
                "identifier_components": {
                    ...
                    "version": 1,
                    "network": "testnet3",
                    "genesis_bytes": bytes.fromhex("026ff0fb2feb271702daefd4f849d64ba0a58aed9f4e2cdb75c6c7886b40d0d1b9")
                }
            },
            {
                ...
                "identifier_components": {
                    ...
                    "version": 1,
                    "network": "signet",
                    "genesis_bytes": bytes.fromhex("02cb42563b126085e1fea427331583bd69ed87057ea9524a6221272469c8d4c000")
                }
            },
            {
